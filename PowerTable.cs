...
namespace ZenStates.Core
{
    public class PowerTable : INotifyPropertyChanged
    {
        ...
        private static readonly PowerTableDef PowerTables = new PowerTableDef
        {
            ...
            { 0x540208, 0x8C4, 0x11C, 0x12C, 0x13C, 0xD4, 0x434, -1, -1, -1, 0xE4 },
            ...
            { 0x620105, 0x994, 0x11C, 0x12C, 0x13C, 0x14C, 0x434, 0x40C, 0x414, -1, 0xE8 },
            // Generic Zen5
            { 0x000620, 0xAFC, 0x11C, 0x12C, 0x13C, 0x14C, 0x434, -1, -1, -1, 0xE8 },

            // ShimadaPeak
            { 0x730404, 0xAFC, 0x20C, 0x21C, 0x22C, 0x23C, 0x5CC, 0x714, 0x71C, -1, 0x1B4 },
            // Generic ShimadaPeak
