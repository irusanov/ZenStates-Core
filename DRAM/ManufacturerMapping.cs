...
namespace ZenStates.Core.DRAM
{
    public static class ManufacturerMapping
    {
        ...
        //
        //  The list is copy from BlackTempel's RAMSPDToolkit: https://github.com/Blacktempel/RAMSPDToolkit/blob/master/RAMSPDToolkit/SPD/Mappings/ManufacturerMapping.cs
        ...
        public static readonly Dictionary<byte, Dictionary<byte, string>> ManufacturerBanks = new Dictionary<byte, Dictionary<byte, string>>
        {
        ...
        public static string Lookup(byte bankByte, byte mfrByte)
        {
            ...
            if (parity != 1 || code == 0)
                return string.Format("Invalid (Bank=0x{0:X2}, ID=0x{1:X2})", bankByte, mfrByte);

            if (ManufacturerBanks.TryGetValue((byte)(cont + 1), out var bankDict) && bankDict.TryGetValue(mfrByte, out var name))
            {
                return name;
            }

            return string.Format("Unknown (Bank {0}, Code 0x{1:X2})", bankByte, mfrByte);
        }
    }
}
